...
/**
 * Created by guilhermedeoliveira on 10/11/16.
 */
...
public class MovieProvider extends ContentProvider {
    ...
    public static final int VIDEO_WITH_MOVIE_ID = 301;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case REVIEW_WITH_MOVIE_ID: // Review/#
                _id = MovieContract.ReviewEntry.getMovieIdFromUri(uri);
                cursor = db.query(
                        MovieContract.ReviewEntry.TABLE_NAME,
                        projection,
            ...
            case VIDEO_WITH_MOVIE_ID: // Video/#
                _id = MovieContract.VideoEntry.getMovieIdFromUri(uri);
                cursor = db.query(
                        MovieContract.VideoEntry.TABLE_NAME,
                        projection,
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case REVIEW:
                ...
                if (_id > 0) {
                    returnUri = MovieContract.ReviewEntry.buildVideoWithId(_id);
                } else {
                    throw new SQLException("Failed to insert row into " + uri);
                }
                break;
            ...
            case VIDEO:
                ...
                if (_id > 0) {
                    returnUri = MovieContract.VideoEntry.buildVideoWithId(_id);
                } else {
                    throw new SQLException("Failed to insert row into " + uri);
                }
                break;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // Deletes all rows return the number of rows deleted
        if (selection == null) {
            selection = "1";
        }
        ...
        // Notify only if there is rows deleted
        if (rowsDeleted != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case VIDEO:
                ...
                for (ContentValues item : values) {
                    long _id = db.insert(MovieContract.VideoEntry.TABLE_NAME, null, item);
                    if (_id != -1) {
                        returnCount++;
                    }
                }
